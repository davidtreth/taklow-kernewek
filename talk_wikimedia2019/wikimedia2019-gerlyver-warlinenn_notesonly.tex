...
\note[item]{There is a species of moth called `Silurian' and this found a Wikimedia image of a Doctor Who character. \cite{Crossing2018}\\Note also: \href{http://termau.cymru/\#apple}{termau.cymru/\#apple} which showed as of July 2019 a picture of Apple headquarters rather than the fruit.\\\href{https://www.xkcd.com/2140/}{xkcd.com/2140 Reinvent the Wheel}\\Also beware of possible API changes.}
\end{frame}
...
\note{Thank everyone for listening, any questions?}
\end{frame}
