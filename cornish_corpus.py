...
names = ["Bewnans Meryasek","Gwreans an Bys","Origo Mundi","Passio Christ","Resurrectio Domini","Solemptnyta","LoTR chapter","Tregear Homilies"]
...
# make a text from the alphabetic words in each of the texts
...
for s in range(len(samples)):
    pylab.axvline(x=((s+1)*width*(len(names)+1)-0.5*width), ymin=0, ymax = 100, linewidth=0.5, color='b', linestyle='-')
