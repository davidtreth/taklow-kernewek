...
endings_present = lostow_personek("ir", "av", "ydh", "", "", "yn", "owgh",
                                  "ons", "a-lemmyn")
endings_preterite = lostow_personek("as", "is", "sys", "as", "as", "syn",
                                    "sowgh", "sons", "tremenys")
# lostow rag verbow gans i
# endings for verbs that use the i vowel
endings_preterite_i = lostow_personek("is", "is", "sys", "is", "is", "syn",
                                      "sowgh", "sons", "tremenys")
endings_imperfect = lostow_personek("ys", "en", "es", "a", "a", "en",
                                    "ewgh", "ens", "anperfydh")
endings_imperfect_i = lostow_personek("ys", "yn", "ys", "i", "i", "yn",
                                      "ewgh", "ens", "anperfydh")
endings_pluperfect = lostow_personek("sys", "sen", "ses", "sa", "sa", "sen",
                                     "sewgh", "sens", "gorperfydh")
endings_subj_pres = lostow_personek("er", "iv", "i", "o", "o", "yn", "owgh",
                                    "ons", "islavarek_a-lemmyn")
endings_subj_imp = lostow_personek("ys", "en", "es", "a", "a", "en", "ewgh",
                                   "ens", "islavarek_anperfydh")
endings_imperative = lostow_personek("", "", "", "es", "es", "yn", "ewgh",
                                     "ens", "gorhemmyn")

tensesDict = {0:"a-lemmyn", 1:"tremenys", 2:"anperfydh", 3:"gorperfydh",
              4:"islavarek_a-lemmyn", 5:"islavarek_anperfydh",
              6:"gorhemmyn", 7:"ppl"}
